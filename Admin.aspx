<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="StudentOrientation.Admin" %>
...
<head id="Head1" runat="server">
    <title>Student Employee Orientation - Admin</title>
...
<body>
    ...
    <div id="header">
        <table id="progress" style="width: 98%; top: 0px">
            <tr>
                <td class="style3">
        ...
        <div id="map">
            <div style="position: absolute; top: 166px; left: 8px; height: 571px; width: 993px;
                ...
                <div style="height: 629px">
                    ...
                    <div style="position: absolute; top: 32px; left: 121px; width: 795px; height: 309px;"
                        id="buttons">
